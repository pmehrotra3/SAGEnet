# train_blockwise_global_cma_nn.py
# Trains BlockwiseGlobalCMAnn (Custom implementation using pycma) on a Gymnasium environment and logs per-episode returns/lengths
...
from FullBlockwiseCMAnn import FullBlockwiseCMAnn
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train FullBlockwiseCMAnn with full episode and system logging.")
    ...
    # --- output directory ---
    out_dir = os.path.join("..", "..", "output", args.env_name, "FullBlockwiseCMAnn")
    ...
    for run in range(1, args.num_runs + 1):
        ...
        model  = FullBlockwiseCMAnn(env=env, block_size=args.block_size)
