...
#
# Usage: python train_intra_layer_blockwise_cma_direct_policy_search.py <env_name> [--total-timesteps N] [--num-runs N] [--block-size N]
#
...
def main():
    ...
    parser.add_argument("--block-size",      type=int, default=4,       help="Number of neurons per block for blockwise CMA-ES (default: 8)")
