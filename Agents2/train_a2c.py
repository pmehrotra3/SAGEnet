# Trains A2C on a Gymnasium environment, logs episode returns/lengths,
...
def main():
    ...
    # -------------------------
    parser = argparse.ArgumentParser(description="Simple A2C training script (full episode logging)")
    ...
    # -------------------------
    out_dir = os.path.join("output", "A2C", args.env_name)
    ...
    if len(episode_returns) > 0:
        ...
        plt.title(f"{args.env_name} – A2C Training")
    ...
    csv_path = os.path.join("output", "A2C", "final_performance.csv")
