# Trains TD3 on a Gymnasium environment, logs episode returns/lengths,
...
def main():
    ...
    # -------------------------
    parser = argparse.ArgumentParser(description="Simple TD3 training script (full episode logging)")
    ...
    # -------------------------
    out_dir = os.path.join("output", "TD3", args.env_name)
    ...
    if len(episode_returns) > 0:
        ...
        plt.title(f"{args.env_name} – TD3 Training")
    ...
    csv_path = os.path.join("output", "TD3", "final_performance.csv")
